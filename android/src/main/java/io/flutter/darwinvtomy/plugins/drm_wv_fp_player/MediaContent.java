...
public class MediaContent {
    ...
    public MediaContent(String name, String uri, String extension, String drm_scheme, String drm_license_url, String ad_tag_uri, List<String> playlist, String spherical_stereo_mode) {
        this.name = name;
        this.uri = uri;
